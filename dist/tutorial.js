...
const tourSteps=[
 ...
 {view:'overview',target:'#goals',title:'Make room for more than one goal',text:'New goal needs just a name and a target. Every goal gets its own progress bar. Add moves money into that goal; Take out moves it back to spending. Your total cash stays the same.'},
